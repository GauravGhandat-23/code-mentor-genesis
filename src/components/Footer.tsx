      ...
      <div className="container mx-auto px-4 py-16">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="inline-block mb-4">
              <div className="flex items-center">
                <span className="text-2xl font-bold text-white mr-2">TestAI</span>
                <span className="bg-blue-600 text-white text-xs px-2 py-1 rounded-md">BETA</span>
              </div>
            </Link>
            <p className="text-slate-400 mb-4 max-w-md">
              Empower your learning journey with AI-driven aptitude and coding tests that adapt to your unique needs and help you reach your goals faster.
            </p>
          </div>
        ...
        <div className="border-t border-slate-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-slate-400 text-sm">
            © {currentYear} TestAI. All rights reserved.
          </p>
